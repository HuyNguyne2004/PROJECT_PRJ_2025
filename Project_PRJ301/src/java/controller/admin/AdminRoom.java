...
public class AdminRoom extends HttpServlet {
    ...
    throws ServletException, IOException {
        List<Rooms> listRoom = roomDao.findAll();  // Giả sử findAll() là phương thức lấy tất cả phòng học

        // Lưu danh sách phòng học vào request
        request.setAttribute("listRoom", listRoom);

        // Chuyển hướng đến JSP hiển thị danh sách phòng học
